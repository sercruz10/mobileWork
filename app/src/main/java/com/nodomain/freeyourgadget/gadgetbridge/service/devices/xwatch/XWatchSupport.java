...
package com.nodomain.freeyourgadget.gadgetbridge.service.devices.xwatch;
...
import com.nodomain.freeyourgadget.gadgetbridge.devices.xwatch.XWatchSampleProvider;
import com.nodomain.freeyourgadget.gadgetbridge.devices.xwatch.XWatchService;
...
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband.DeviceInfo;
...
public class XWatchSupport extends AbstractBTLEDeviceSupport {
    ...
    private void requestSummarizedData(TransactionBuilder builder) {
        byte[] fetch = new byte[]{XWatchService.COMMAND_ACTIVITY_TOTALS,
                (byte) 0,
                (byte) 0,
                (byte) 0,
                (byte) 0,
    ...
    private void requestDetailedData(TransactionBuilder builder) {
        byte[] fetch = new byte[]{XWatchService.COMMAND_ACTIVITY_DATA,
                dayToFetch,
                (byte) 0,
                (byte) 0,
                (byte) 0,
