...
package com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband2;
...
import com.nodomain.freeyourgadget.gadgetbridge.Logging;
import com.nodomain.freeyourgadget.gadgetbridge.R;
import com.nodomain.freeyourgadget.gadgetbridge.activities.SettingsActivity;
...
import com.nodomain.freeyourgadget.gadgetbridge.deviceevents.GBDeviceEventBatteryInfo;
import com.nodomain.freeyourgadget.gadgetbridge.deviceevents.GBDeviceEventCallControl;
import com.nodomain.freeyourgadget.gadgetbridge.deviceevents.GBDeviceEventFindPhone;
import com.nodomain.freeyourgadget.gadgetbridge.deviceevents.GBDeviceEventVersionInfo;
import com.nodomain.freeyourgadget.gadgetbridge.devices.SampleProvider;
import com.nodomain.freeyourgadget.gadgetbridge.devices.huami.ActivateDisplayOnLift;
import com.nodomain.freeyourgadget.gadgetbridge.devices.huami.HuamiCoordinator;
import com.nodomain.freeyourgadget.gadgetbridge.devices.huami.HuamiFWHelper;
import com.nodomain.freeyourgadget.gadgetbridge.devices.huami.amazfitbip.AmazfitBipService;
import com.nodomain.freeyourgadget.gadgetbridge.devices.huami.miband2.MiBand2FWHelper;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.DateTimeDisplay;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.DoNotDisturb;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBand2SampleProvider;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBand2Service;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandCoordinator;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandService;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband.VibrationProfile;
import com.nodomain.freeyourgadget.gadgetbridge.devices.miband2.MiBand2Const;
...
import com.nodomain.freeyourgadget.gadgetbridge.entities.MiBandActivitySample;
import com.nodomain.freeyourgadget.gadgetbridge.entities.User;
import com.nodomain.freeyourgadget.gadgetbridge.impl.GBAlarm;
import com.nodomain.freeyourgadget.gadgetbridge.impl.GBDevice.State;
import com.nodomain.freeyourgadget.gadgetbridge.model.ActivitySample;
import com.nodomain.freeyourgadget.gadgetbridge.model.ActivityUser;
...
import com.nodomain.freeyourgadget.gadgetbridge.model.CalendarEvents;
...
import com.nodomain.freeyourgadget.gadgetbridge.model.DeviceService;
...
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.AbstractBTLEDeviceSupport;
...
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.GattCharacteristic;
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.GattService;
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.TransactionBuilder;
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.actions.AbortTransactionAction;
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.actions.SetDeviceStateAction;
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.profiles.alertnotification.AlertCategory;
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfoProfile;
import com.nodomain.freeyourgadget.gadgetbridge.service.btle.profiles.heartrate.HeartRateProfile;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.common.SimpleNotification;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.huami.HuamiDeviceEvent;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband.NotificationStrategy;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband.RealtimeSamplesSupport;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband2.actions.StopNotificationAction;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband2.operations.FetchActivityOperation;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband2.operations.FetchSportsSummaryOperation;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband2.operations.InitOperation;
import com.nodomain.freeyourgadget.gadgetbridge.service.devices.miband2.operations.UpdateFirmwareOperation;
import com.nodomain.freeyourgadget.gadgetbridge.util.GB;
import com.nodomain.freeyourgadget.gadgetbridge.util.NotificationUtils;
import com.nodomain.freeyourgadget.gadgetbridge.util.Prefs;
import com.nodomain.freeyourgadget.gadgetbridge.util.Version;
...
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COLOUR;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_COUNT;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_DURATION;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_FLASH_ORIGINAL_COLOUR;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_COUNT;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_DURATION;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PAUSE;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.DEFAULT_VALUE_VIBRATION_PROFILE;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.FLASH_COLOUR;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.FLASH_COUNT;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.FLASH_DURATION;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.FLASH_ORIGINAL_COLOUR;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.VIBRATION_COUNT;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.VIBRATION_DURATION;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.VIBRATION_PAUSE;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.VIBRATION_PROFILE;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.getNotificationPrefIntValue;
import static com.nodomain.freeyourgadget.gadgetbridge.devices.miband.MiBandConst.getNotificationPrefStringValue;
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (s.equals(DeviceInfoProfile.ACTION_DEVICE_INFO)) {
                handleDeviceInfo((com.nodomain.freeyourgadget.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo) intent.getParcelableExtra(DeviceInfoProfile.EXTRA_DEVICE_INFO));
            }
        }
    };
...
//        }
    ...
    private void handleDeviceInfo(com.nodomain.freeyourgadget.gadgetbridge.service.btle.profiles.deviceinfo.DeviceInfo info) {
