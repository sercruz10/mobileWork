...
public class GBDeviceAppAdapter extends RecyclerView.Adapter<GBDeviceAppAdapter.AppViewHolder> {
    ...
    public class AppViewHolder extends RecyclerView.ViewHolder {
        ...
        AppViewHolder(View itemView) {
            super(itemView);
            mDeviceAppVersionAuthorLabel = itemView.findViewById(R.id.item_details);
            mDeviceAppNameLabel = itemView.findViewById(R.id.item_name);
            mDeviceImageView = itemView.findViewById(R.id.item_image);
