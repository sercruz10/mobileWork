...
public class AndroidUtils {
    ...
    */
    private static @Nullable String internalGetFilePath(@NonNull Context context, @NonNull Uri uri) {
    ...
    public static void viewFile(String path, String action, Context context) {
