...
public class DeviceManager {
    ...
    public static final String ACTION_DEVICES_CHANGED
            = "com.nodomain.freeyourgadget.gadgetbridge.devices.devicemanager.action.devices_changed";
    /**
    ...
    public static final String ACTION_REFRESH_DEVICELIST
            = "com.nodomain.freeyourgadget.gadgetbridge.devices.devicemanager.action.set_version";
