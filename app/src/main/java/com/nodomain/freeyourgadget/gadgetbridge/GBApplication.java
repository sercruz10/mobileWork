...
package com.nodomain.freeyourgadget.gadgetbridge;
...
import com.nodomain.freeyourgadget.gadgetbridge.database.DBOpenHelper;
import com.nodomain.freeyourgadget.gadgetbridge.devices.DeviceManager;
import com.nodomain.freeyourgadget.gadgetbridge.entities.DaoMaster;
import com.nodomain.freeyourgadget.gadgetbridge.externalevents.BluetoothStateChangeReceiver;
import com.nodomain.freeyourgadget.gadgetbridge.impl.GBDevice;
import com.nodomain.freeyourgadget.gadgetbridge.impl.GBDeviceService;
...
import com.nodomain.freeyourgadget.gadgetbridge.service.NotificationCollectorMonitorService;
...
public class GBApplication extends Application {
    ...
    public static final String ACTION_QUIT
            = "com.nodomain.freeyourgadget.gadgetbridge.gbapplication.action.quit";
    public static final String ACTION_LANGUAGE_CHANGE = "com.nodomain.freeyourgadget.gadgetbridge.gbapplication.action.language_change";
    ...
    private static boolean isPrioritySender(int prioritySenders, String number) {
        if (prioritySenders == Policy.PRIORITY_SENDERS_ANY) {
            ...
            if (prioritySenders == Policy.PRIORITY_SENDERS_CONTACTS && exists) {
                return true;
            } else return prioritySenders == Policy.PRIORITY_SENDERS_STARRED && starred == 1;
        }
    }
